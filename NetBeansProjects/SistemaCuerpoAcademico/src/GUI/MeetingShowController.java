...
public class MeetingShowController implements Initializable {
    ...
    @FXML
    private Button btShowSchedule;
    @FXML
    private Button btReturn;
    @FXML
    private TableView tvAssistants;
    @FXML
    private Button btMeetingStart;
    @FXML
    private Button btUpdate;
    @FXML
    private Button btShowMinute;
    @FXML
    private Button btRegisterMinute;
    @FXML
    private TableView<Prerequisite> tvPrerequisites;
    @FXML
    private TableColumn<Prerequisite, String> tcDescription;
    @FXML
    private TableColumn<Prerequisite, Member> tcMandated;
    @FXML
    private TableColumn<Member, String> tcRole;
    @FXML
    private TableColumn<Member, String> tcMember;
    ...
    private boolean checkIfSecretary() {
        boolean isSecretary = false;
        if (!btMeetingStart.getText().equals("Ver minuta")) {
            for (int i = 0; i < assistants.size(); i++) {
                if (member.getProfessionalLicense().equals(assistants.get(i).getProfessionalLicense())) {
                    if (assistants.get(i).getRole().equals("Secretario")) {
                          isSecretary = true;
                    }
                }
            }
